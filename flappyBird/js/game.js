 ...
 */
var Game=function (imglist,WINDOW_WIDTH,WINDOW_HEIGHT,canvas) {
    ...
    load(imglist, function (imgEls) {
        ...
        function run() {
            ...
            if(gameOver){
                ...
                ctx.font = "30px microsoft yahei";
                ctx.fillText("SCORE: "+pipes[0].getScore(), WINDOW_WIDTH / 2, WINDOW_HEIGHT *3/7);
            }else {
        ...
        /*            cvs.addEventListener("touch", function () {
         bird.speed = -0.25 * PROPORTION;
         });*/
